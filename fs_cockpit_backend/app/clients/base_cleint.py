...
from app.exceptions.custom_exceptions import ServiceTimeoutError, ServiceConnectionError
    ...
    async def _request(
        ...
        **kwargs
        ...
        try:
            ...
            logger.error(f"Timeout: {method} {endpoint} - {e}", service=service_name, timeout=self.timeout)
            ...
            logger.error(f"Connection Error: {method} {endpoint} - {e}", service=service_name, url=f"{self.base_url}{endpoint}")
