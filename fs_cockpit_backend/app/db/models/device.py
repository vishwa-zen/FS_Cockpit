...
class Device(Base):
    ...
    def to_dict(self):
        ...
        return {
            ...
            'last_intune_sync': self.last_intune_sync.isoformat() if self.last_intune_sync else None,
            'last_servicenow_sync': self.last_servicenow_sync.isoformat() if self.last_servicenow_sync else None,
        }
