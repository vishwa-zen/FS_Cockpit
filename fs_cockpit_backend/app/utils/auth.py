...
def require_role(required_role: str):
    ...
    def role_checker(user: Dict[str, Any] = Depends(require_auth)) -> Dict[str, Any]:
        ...
        logger.debug("Role check passed", required_role=required_role, user_email=user.get("email"))
...
def require_any_role(*required_roles: str):
    ...
    def role_checker(user: Dict[str, Any] = Depends(require_auth)) -> Dict[str, Any]:
        ...
        logger.debug(
            "Role check passed", required_roles=list(required_roles), user_email=user.get("email")
        )
